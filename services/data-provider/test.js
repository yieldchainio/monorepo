...
for (let i = 0; i < tokens.length; i++) {
    ...
    if (token.address != ethers.getAddress(token.address)) {
        ...
        tokensToUpdateChecksum[1].push(ethers.getAddress(token.address));
    }
}
console.log("Gonna execute promises, amount of:", tokensToUpdateChecksum[0].length);
