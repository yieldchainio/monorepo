...
export const getErrorLog = (info: string, id: string) => {
  return <ErrorMessage id={id}>{info}</ErrorMessage>;
};

export const getWarningLog = (info: string, id: string) => {
  return <WarningMessage id={id}>{info}</WarningMessage>;
};

export const getSuccessLog = (info: string, id: string) => {
  return <SuccessMessage id={id}>{info}</SuccessMessage>;
};
export const getInfoLog = (info: string, id: string) => {
