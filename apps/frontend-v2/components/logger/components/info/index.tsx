...
export const InfoMessage = ({ children, id }: LogMessageProps) => {
  const remove = useLogs((state) => state.remove);

  return (
    <div className="w-full h-max min-w-[40vw] min-h-[5vh] bg-custom-componentbg backdrop-blur-sm bg-opacity-90 rounded-lg flex flex-row items-center justify-center px-6 animate-log pointer-events-auto ">
