...
app.post("/add-token", async (req: any, res: any) => {
  ...
  let tTokenId = await getTableAvailablePrimaryKey(
    "tokens",
    "token_identifier"
  );
...
app.post("/add-function-to-action", async (req: any, res: any) => {
  console.log("Inside Add Function To action, req: ", req.body);
  let actionDetails = await genericQuery(
    "*",
    "actions",
    "action_identifier",
    req.body.action_identifier
  );
...
app.post("/add-protocol-network", async (req: any, res: any) => {
...
app.post("/add-protocol-address", async (req: any, res: any) => {
...
app.post("/add-address", async (req: any, res: any) => {
  let tAddressId = await getTableAvailablePrimaryKey(
    "addresses",
    "address_identifier"
  );
...
app.post("/add-parameter", async (req: any, res: any) => {
  let tParamId = await getTableAvailablePrimaryKey(
    "parameters",
...
app.post("/add-flow", async (req: any, res: any) => {
...
app.post("/add-function", async (req: any, res: any) => {
  let tFuncId = await getTableAvailablePrimaryKey(
    "functions",
    "function_identifier"
  );
...
app.post(
  "/update-function/:function_identifier",
...
// ====================
app.listen(PORT, () =>
  console.log(`Integration Provider is running on port ${PORT}`)
);
