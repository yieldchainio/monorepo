...
contract EdenPoop {
    ...
    string public strategyTitle = "Eden Poop";
    ...
    function deposit_post(bytes[] memory _arguments) public onlyExecutor {
        ...
        GNS_BALANCE =
            (GNS.balanceOf(address(this)) - GNS_BALANCE) *
            activeDivisor;
        ...
        onlyExecutor
    {
        ...
        bool success;
        if (useCustomParams) {
            (success, result) = currentFunctionAddress.call{value: 0}(
    ...
    function func_31(string memory _funcToCall, bytes[1] memory _arguments)
        public
        onlyExecutor
    {
        ...
        require(
            success,
            "Function Call Failed On func_31, Strategy Execution Aborted"
        );
    }
    ...
    function func_33(string memory _funcToCall, bytes[1] memory _arguments)
        public
        onlyExecutor
    {
        address currentFunctionAddress = 0x6B8D3C08072a020aC065c467ce922e3A36D3F9d6;
        ...
        require(
            success,
            "Function Call Failed On func_33, Strategy Execution Aborted"
        );
    }

    function func_37(string memory _funcToCall, bytes[7] memory _arguments)
        public
        onlyExecutor
    {
        address currentFunctionAddress = 0xCeceA7260eaF5B38C10D7183DBBE60969D3dD2a8;
        bool useCustomParams = keccak256(_arguments[0]) ==
            keccak256(abi.encode("donotuseparamsever"))
            ? false
            : true;
        ...
        if (useCustomParams) {
            (success, result) = currentFunctionAddress.call{value: 0}(
                abi.encodeWithSignature(
                    "addLiquidityYc(string,address[],address[],uint256[],uint256[],uint256,bytes[])",
                    abi.decode(_arguments[0], (string)),
                    abi.decode(_arguments[1], (address[])),
                    abi.decode(_arguments[2], (address[])),
                    abi.decode(_arguments[3], (uint256[])),
                    abi.decode(_arguments[4], (uint256[])),
                    abi.decode(_arguments[5], (uint256)),
            ...
            (success, result) = currentFunctionAddress.call{value: 0}(
                abi.encodeWithSignature(
                    "addLiquidityYc(string,address[],address[],uint256[],uint256[],uint256,bytes[])",
                    abi.decode(current_custom_arguments[0], (string)),
                    abi.decode(current_custom_arguments[1], (address[])),
                    abi.decode(current_custom_arguments[2], (address[])),
                    abi.decode(current_custom_arguments[3], (uint256[])),
                    abi.decode(current_custom_arguments[4], (uint256[])),
                    abi.decode(current_custom_arguments[5], (uint256)),
                    abi.decode(current_custom_arguments[6], (bytes[]))
                )
            );
        }
        latestContractData = result;
        require(
            success,
            "Function Call Failed On func_37, Strategy Execution Aborted"
        );
    }
    ...
    function func_32(string memory _funcToCall, bytes[1] memory _arguments)
        public
        onlyExecutor
    {
        address currentFunctionAddress = 0x6B8D3C08072a020aC065c467ce922e3A36D3F9d6;
        ...
        require(
            success,
            "Function Call Failed On func_32, Strategy Execution Aborted"
        );
    }

    function func_38(string memory _funcToCall, bytes[5] memory _arguments)
        public
        onlyExecutor
    {
        address currentFunctionAddress = 0xCeceA7260eaF5B38C10D7183DBBE60969D3dD2a8;
        ...
        if (useCustomParams) {
            (success, result) = currentFunctionAddress.call{value: 0}(
                abi.encodeWithSignature(
                    "removeLiquidityYc(string,address[],address[],bytes[],uint256[])",
                    abi.decode(_arguments[0], (string)),
                    abi.decode(_arguments[1], (address[])),
                    abi.decode(_arguments[2], (address[])),
                    abi.decode(_arguments[3], (bytes[])),
                    abi.decode(_arguments[4], (uint256[]))
                )
            );
        } else {
            (success, result) = currentFunctionAddress.call{value: 0}(
                abi.encodeWithSignature(
                    ...
                    abi.decode(current_custom_arguments[1], (address[])),
                    abi.decode(current_custom_arguments[2], (address[])),
                    abi.decode(current_custom_arguments[3], (bytes[])),
                    abi.decode(current_custom_arguments[4], (uint256[]))
                )
            );
        }
        ...
        require(
            success,
            "Function Call Failed On func_38, Strategy Execution Aborted"
        );
    }
    ...
    function updateStepsDetails() internal {
        ...
        step_4_custom_args = [
            abi.encode("zyberswap"),
            abi.encode([0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1]),
            abi.encode([0x82aF49447D8a07e3bd95BD0d56f35241523fBab1]),
            abi.encode([DAI_BALANCE / activeDivisor]),
            abi.encode([WETH_BALANCE / activeDivisor]),
            abi.encode(40),
            abi.encode([0x00])
        ];
